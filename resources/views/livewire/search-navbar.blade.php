<div x-data="{ searchOpen: false }" @click.away="searchOpen = false" class="relative w-full">
    <input
        ...
        type="text"
        class="w-full h-7 px-4 py-1 pl-8 text-sm rounded-md bg-emerald-100 {{ !request()->routeIs('anime.*') ? 'dark:bg-gray-800' : 'dark:bg-gray-900' }} focus:outline-none focus:ring focus:ring-emerald-300"
        placeholder="Cari..."
