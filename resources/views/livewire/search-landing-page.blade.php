<div class="w-full mt-3 md:mt-0">
    <div class="relative">
        ...
        type="text"
        class="w-full h-12 px-4 py-1 pl-8 text-lg bg-emerald-100 bg-opacity-50 rounded-md dark:bg-emerald-800 focus:outline-none focus:ring focus:ring-emerald-300"
        placeholder="Cari..."
        />
    ...
    <div x-cloak class="flex flex-col h-48 pt-2">
        ...
        <x-library-scroll wire:loading.remove class="w-full">
            ...
            <div class="flex flex-col shrink-0 text-emerald-900 bg-gray-100 divide-y divide-gray-400 rounded-lg w-44 md:w-48 xl:w-48 snap-center group dark:bg-gray-800 dark:text-gray-50 divide-opacity-50 divide-dashed">
