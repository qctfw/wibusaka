<x-app-layout>
    ...
    <div class="container px-4 pt-12 mx-auto">
        <a href="{{ route('anime.top.popular') }}" class="text-lg font-semibold tracking-wider text-blue-700 uppercase dark:text-blue-300">Top Anime</a>
        ...
        <a href="{{ route('anime.top.upcoming') }}" class="pt-12 text-lg font-semibold tracking-wider text-blue-700 uppercase dark:text-blue-300">Anime Paling Dinantikan</a>
        <div class="grid items-end grid-cols-2 gap-8 py-4 md:grid-cols-3 lg:grid-cols-6">
