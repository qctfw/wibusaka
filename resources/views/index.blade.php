<x-app-layout>
    ...
    <div class="container mx-auto px-4 pt-12">
        <h2 class="uppercase tracking-wider text-blue-700 text-lg font-semibold">Top Anime</h2>
        ...
        <h2 class="uppercase tracking-wider text-blue-700 text-lg font-semibold pt-12">Anime Paling Dinantikan</h2>
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 items-end gap-8 py-4">
