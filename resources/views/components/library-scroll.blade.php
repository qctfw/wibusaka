<div {{ $attributes->merge(['class' => 'relative']) }} x-data="{scroll: 0}">
    ...
    <button
        class="absolute hidden md:flex items-center justify-center w-12 h-12 bg-gray-900 rounded-full shadow-md inset-y-1/2 -left-5 transition-colors bg-opacity-80 ring-0 hover:bg-opacity-100 hover:bg-gray-600 disabled:opacity-0"
    ...
    <button
        class="absolute hidden md:flex items-center justify-center w-12 h-12 bg-gray-900 rounded-full shadow-md inset-y-1/2 -right-5 transition-colors bg-opacity-80 ring-0 hover:bg-opacity-100 hover:bg-gray-600 disabled:opacity-0"
