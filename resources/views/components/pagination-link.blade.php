<div class="flex flex-row items-center justify-center gap-4 mt-4">
    ...
    <a href="{{ ($current != $link) ? '?page=' . $link : '#' }}" class="flex items-center justify-center w-10 h-10 p-2 text-lg font-semibold transition-colors bg-gray-200 rounded-lg dark:bg-gray-900 hover:bg-gray-300 dark:hover:bg-gray-700">{{ $link }}</a>
    @endforeach
