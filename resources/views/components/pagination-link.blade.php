<div class="flex flex-row items-center justify-center gap-4">
    ...
    <a href="?page=1" class="flex items-center justify-center w-10 h-10 p-2 text-lg font-semibold transition-colors bg-gray-100 rounded-lg dark:bg-gray-800 hover:bg-gray-300 dark:hover:bg-emerald-700">
