<div class="flex flex-col bg-gray-200 dark:bg-gray-900 rounded-lg">
    ...
    <a href="{{ route('anime.show', ['id' => $anime['mal_id']]) }}">
        <h4 class="text-lg text-center leading-tight font-semibold py-1 border-b border-dashed border-gray-400 border-opacity-50 transition-colors duration-200 hover:text-blue-300">
            {{ $anime['title'] }}
        </h4>
    </a>
