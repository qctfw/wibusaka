<footer class="mt-4 bg-green-800 border-t border-gray-200 footer dark:bg-gray-800 dark:border-gray-700">
    <div class="container flex flex-col items-center justify-between gap-1 px-4 py-6 text-green-50 mx-auto md:flex-row md:items-start">
